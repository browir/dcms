...
.mcw-icon-today   { background-color: rgba(59, 130, 246, 0.10); color: #3b82f6; }
.mcw-icon-invited { background-color: rgba(139, 92, 246, 0.10); color: #8b5cf6; }
...
.mcw-table thead tr { border-bottom: 1px solid rgba(0, 0, 0, 0.06); }
...
.mcw-table tbody tr:last-child td { border-bottom: none; }
.mcw-table tbody tr:hover { background-color: rgba(59, 130, 246, 0.03); }
...
.col-title  { width: 40%; min-width: 80px; }
.col-time   { width: 25%; min-width: 60px; white-space: nowrap; }
.col-loc    { width: 20%; min-width: 60px; }
.col-status { width: 15%; min-width: 70px; }
...
.badge-primary { background-color: rgba(59, 130, 246, 0.12);  color: #1d4ed8; }
.badge-gray    { background-color: rgba(107, 114, 128, 0.12); color: #4b5563; }
.badge-danger  { background-color: rgba(239, 68, 68, 0.12);   color: #b91c1c; }
...
@media (min-width: 1024px) {
    ...
    .mcw-panel {
        ...
        flex-shrink: 1;
        flex-basis: 0%;
        min-width: 0;     /* wajib agar panel bisa menyempit */
        position: relative;
    }
